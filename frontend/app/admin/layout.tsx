...
function navClass(href: string) {
      ...
      <aside className="fixed left-0 top-0 z-40 hidden h-screen w-[280px] bg-[#0f172a] text-white lg:block">
        <div className="flex h-full flex-col px-5 py-5">
          ...
          <nav className="mt-4 space-y-0 text-[15px] font-bold">
            ...
            <Link href="/admin/companies" className={navClass("/admin/companies")}>
              <Building2 size={19} /> Kompanitë
            </Link>

            <Link href="/admin/professionals" className={navClass("/admin/professionals")}>
              <CircleUserRound size={19} /> Mjeshtrit / Profesionistët
            </Link>

            <Link href="/admin/pending" className={navClass("/admin/pending")}>
              <Users size={19} /> Në pritje
            </Link>

            <Link href="/admin/approved" className={navClass("/admin/approved")}>
              <CheckCircle2 size={19} /> Të aprovuara
            </Link>

            <Link href="/admin/rejected" className={navClass("/admin/rejected")}>
              <X size={19} /> Refuzimet
            </Link>
            ...
            <Link href="/admin/verifications" className={navClass("/admin/verifications")}>
            ...
            <Link href="/admin/roles" className={navClass("/admin/roles")}>
            ...
            <Link href="/admin/cities" className={navClass("/admin/cities")}>
  ...
  <header className="sticky top-0 z-30 flex h-[72px] items-center justify-between border-b border-slate-200 bg-white/90 px-8 backdrop-blur">
