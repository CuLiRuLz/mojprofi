        ...
        <section className="bg-blue-50 px-8 py-8 lg:px-10">
          ...
          <div className="mt-12">
            <h1 className="text-4xl font-black leading-tight tracking-tight">
              Krijo llogarinë <br /> e profesionistit
            </h1>

            <p className="mt-4 max-w-sm text-base leading-relaxed text-slate-600">
              Thjesht, shpejt dhe profesional. Prezanto aftësitë e tua dhe gjej
              më shumë klientë.
            </p>
          ...
          <div className="mt-8 space-y-5">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold">Profil i personalizuar</h3>
                <p className="mt-1 text-sm text-slate-600">
                  Prezanto veten dhe eksperiencën tënde.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Lidhu direkt me klientët e interesuar.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold">Shfaq projektet e tua</h3>
                <p className="mt-1 text-sm text-slate-600">
                  Ndërto portofolin profesional.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold">Ndërto reputacionin tënd</h3>
                <p className="mt-1 text-sm text-slate-600">
                  Fito vlerësime dhe besimin e klientëve.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="flex items-center justify-center px-8 py-8 lg:px-16">
          <div className="w-full max-w-xl">
            ...
            <p className="mt-2 text-base text-slate-600">
              Plotëso të dhënat bazë për të krijuar profilin.
            </p>
            ...
            <form onSubmit={handleRegister} className="mt-7 space-y-4">
              ...
              <button
                disabled={loading}
                className="w-full rounded-2xl bg-blue-600 px-5 py-4 font-bold text-white hover:bg-blue-700 disabled:opacity-60"
              >
                {loading
                  ? "Duke u regjistruar..."
